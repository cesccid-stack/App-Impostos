  ...
  expensesCard.appendChild(
    createFormSection(
      ...
      createFormRow(
        createField({
          id: 'union-fees',
          label: 'Quotes sindicals (Casella 0013)',
          value: w.unionFees,
          suffix: '€',
          placeholder: '0,00',
          hint: 'Quotes satisfetes a organitzacions sindicals',
          onChange: (val) => store.update('workIncome', { unionFees: parseFloat(val) || 0 }),
        }),
        createField({
          id: 'prof-college-fees',
          label: 'Quotes col·legis professionals (Casella 0015)',
          value: w.professionalCollegeFees || 0,
          suffix: '€',
          placeholder: '0,00',
          hint: 'Col·legiació obligatòria (Art. 19.2.d LIRPF - Deduïble fins a 500,00 €)',
          onChange: (val) => store.update('workIncome', { professionalCollegeFees: parseFloat(val) || 0 }),
        }),
      ),
      createFormRow(
        createField({
          id: 'legal-defense-fees',
          label: 'Defensa jurídica laboral (Casella 0016)',
        ...
        createField({
          ...
          suffix: '€',
          placeholder: '0,00',
          hint: 'Mobilitat geogràfica, despeses específiques addicionals',
      ...
      createFormRow(
        ...
        createField({
          id: 'severance-pay',
          label: 'Indemnització per acomiadament (Art. 7.e LIRPF)',
